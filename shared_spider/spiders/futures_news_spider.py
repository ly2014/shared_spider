...
class FuturesNews(RedisSpider):
    name = 'ftn_spider'
    redis_key = 'ftn:start_urls'
    # start_urls = ['https://futures.stockstar.com/list/2443.shtml']
    ...
    def parse(self, response):
        ...
        if next_page:
            url = 'https://futures.stockstar.com/list/' + next_page
