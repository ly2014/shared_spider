...
class InsuranceNews(RedisSpider):
    name = 'in_spider'
    redis_key = 'in:start_urls'
    # start_urls = ['https://insurance.stockstar.com/list/1563.shtml']
    ...
    def parse(self, response):
        ...
        if next_page:
            url = 'https://insurance.stockstar.com/list/' + next_page
