...
class InternationalFinancial(RedisSpider):
    name = 'if_spider'
    redis_key = 'if:start_urls'
    # start_urls = ['http://finance.stockstar.com/list/955.shtml']
    ...
    def parse(self, response):
        ...
        if next_page:
            url = 'http://finance.stockstar.com/list/' + next_page
