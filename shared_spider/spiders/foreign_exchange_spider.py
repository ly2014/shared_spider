...
class ForeignExchange(RedisSpider):
    name = 'fe_spider'
    redis_key = 'fe:start_urls'
    # start_urls = ['http://forex.stockstar.com/list/1699.shtml']

    def parse(self, response):
        news = response.xpath('//div[@class="newslist"]/ul/li')
        ...
        if next_page:
            url = 'http://forex.stockstar.com/list/' + next_page
